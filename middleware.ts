...
export const config = {
  matcher: [
     ...
     */
    '/((?!_next/static|_next/image|_next/webpack-hmr|favicon.ico|manifest.webmanifest|manifest-admin-precios|manifest-admin-precios\\.json|.*\\.(?:svg|png|jpg|jpeg|gif|webp|ico|woff2?)$).*)',
  ],
};
