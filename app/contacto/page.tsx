            ...
            <div className="bg-gray-900 p-6 md:p-12 rounded-[30px] md:rounded-[60px] shadow-2xl relative overflow-hidden w-full max-w-2xl mx-auto lg:mx-0 order-1 lg:order-none">
              ...
              <div className="relative z-10">
                ...
                <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
                  ...
                  <button
                    type="button"
                    className="w-full py-4 md:py-5 rounded-2xl font-black uppercase tracking-[0.15em] text-xs md:text-sm transition-all duration-300 flex items-center justify-center gap-3 bg-[#E30613] text-white active:scale-95"
                  >
